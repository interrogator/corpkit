...
To download the most recent OSX version, use the link in the menu bar, or just [click here](https://github.com/interrogator/corpkit-app/raw/master/corpkit-1.84.tar.gz). See the [Setup page](doc_setup.html) for (very simple) installation instructions.
