...
To download the most recent OSX version, use the link in the menu bar, or just [click here](https://github.com/interrogator/corpkit-app/raw/master/corpkit-2.1.5.tar.gz). See the [Setup page](doc_setup.html) for (very simple) installation instructions.
